...
if (isset($this->d_ubah)) {
    ...
    echo 'Tambah Data SMI';
}
?></legend>
            <div id="form-input"><div class="kiri">
                    <form method="POST" action="<?php
                if (isset($this->d_ubah)) {
                    echo URL . 'dataSmi/updDataSmi';
                } else {
                    $_SERVER['PHP_SELF'];
                }
?>">
                              <?php
                              if (isset($this->d_ubah)) {
                                  echo "<input type=hidden name='kd_d_smi' value=" . $this->d_ubah->get_kd_d_smi() . ">";
                              }
                        ...
                        <ul class="inline tengah">
                            ...
                            <li><input class="sukses" type="submit" name="<?php echo isset($this->d_ubah) ? 'upd_d_smi' : 'add_d_smi'; ?>" value="SIMPAN" onClick="return cek();"></li>
                        </ul>
                    </form>
                </div>
            </div>
    ...
    <div class="kolom4" id="table">
        <fieldset><legend>Data SMI</legend>
                ...
                <table class="table-bordered zebra scroll">
                    ...
                    <tbody>
                        ...
                        foreach ($this->data as $val) {
                            ...
                            echo "<td><a href=" . URL . "dataSmi/delDataSmi/" . $val->get_kd_d_smi() . " onclick=\"return del('" . $val->get_kd_d_user() . "')\"><i class=\"icon-trash\"></i></a>
                        <a href=" . URL . "dataSmi/addDataSmi/" . $val->get_kd_d_smi() . "><i class=\"icon-pencil\"></i></a></td>";
                            echo "</tr>";
                            $no++;
                        }
                        ?>
