        ...
        <fieldset>
            ...
            <div id="form-input"><div class="kiri">
                    ...
                    ?>
                        ...
                        <label>KPPN</label><input type="text" name="kd_r_unit" id="kd_r_unit" size="8" value="<?php echo isset($this->d_ubah) ? $this->d_ubah->get_kd_r_unit() : (isset($this->d_rekam) ? $this->d_rekam->get_kd_r_unit() : ''); ?>">
                        <div id="wunit" class="error"></div>
                        <label>BA.999</label><input type="text" name="kd_r_unit" id="kd_r_unit" size="8" value="<?php echo isset($this->d_ubah) ? $this->d_ubah->get_kd_r_unit() : (isset($this->d_rekam) ? $this->d_rekam->get_kd_r_unit() : ''); ?>">
                        </select>
                ...
                <div id="form-input"><div class="kiri">
                    ...
                    if (isset($this->d_ubah)) {
                        ...
                        $_SERVER['PHP_SELF'];
                            ...
                            <div id="wunit" class="error"></div>
                            <label>SP2D</label><input type="text" name="kd_r_unit" id="kd_r_unit" size="8" value="<?php echo isset($this->d_ubah) ? $this->d_ubah->get_kd_r_unit() : (isset($this->d_rekam) ? $this->d_rekam->get_kd_r_unit() : ''); ?>">
                            <div id="wunit" class="error"></div>
                            <label>LHP</label><input type="text" name="kd_r_unit" id="kd_r_unit" size="8" value="<?php echo isset($this->d_ubah) ? $this->d_ubah->get_kd_r_unit() : (isset($this->d_rekam) ? $this->d_rekam->get_kd_r_unit() : ''); ?>">
                            <div id="wfo1"  class="error"></div>
                            <label>REKON</label><input type="text" name="d_tetap_fo1" id="d_tetap_fo1" size="50" value="<?php echo isset($this->d_ubah) ? $this->d_ubah->get_d_tetap_fo1() : (isset($this->d_rekam) ? $this->d_rekam->get_d_tetap_fo1() : ''); ?>">
                            </select>
                            <ul class="inline tengah">
                                <li><input class="normal" type="submit" onclick="" value="BATAL"></li>
                                <li><input class="sukses" type="submit" name="<?php echo isset($this->d_ubah) ? 'upd_d_tetap' : 'add_d_tetap'; ?>" value="SIMPAN" onClick="return cek();"></li>
                ...
                <div id="form-input"><div class="kiri">
                    ...
                    if (isset($this->d_ubah)) {
                        ...
                        $_SERVER['PHP_SELF'];
                            ...
                            <div id="wunit" class="error"></div>
                            <label>SPM</label><input type="text" name="kd_r_unit" id="kd_r_unit" size="8" value="<?php echo isset($this->d_ubah) ? $this->d_ubah->get_kd_r_unit() : (isset($this->d_rekam) ? $this->d_rekam->get_kd_r_unit() : ''); ?>">
                            <div id="wunit" class="error"></div>
                            <label>KONTRAK</label><input type="text" name="kd_r_unit" id="kd_r_unit" size="8" value="<?php echo isset($this->d_ubah) ? $this->d_ubah->get_kd_r_unit() : (isset($this->d_rekam) ? $this->d_rekam->get_kd_r_unit() : ''); ?>">
                            <div id="wfo1"  class="error"></div>
                            <label>REKON</label><input type="text" name="d_tetap_fo1" id="d_tetap_fo1" size="50" value="<?php echo isset($this->d_ubah) ? $this->d_ubah->get_d_tetap_fo1() : (isset($this->d_rekam) ? $this->d_rekam->get_d_tetap_fo1() : ''); ?>">
                            </select>
                            <ul class="inline tengah">
